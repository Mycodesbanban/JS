...
function adicionar ( ventor1 , ventor2){
    for ( let i = 0 ; i <vetorAdiciona.length;i++){
        console.log(vetorAdiciona[i])
        vetorPilha.push(vetorAdiciona[i])
    }
    console.log("Ver resultado adicionado: " + vetorAdiciona)
    console.log("Ver resulato final: "+ vetorPilha)
}
adicionar(vetorAdiciona , vetorPilha)